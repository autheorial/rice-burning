	...
	<div class="<?php echo $oddcomment; ?>" id="comment-<?php comment_ID() ?>" style="clear: both;">
       ...
       <table style="width:100%"><tbody><tr>
		...
		<td class="info">
			...
			<?php echo get_avatar( $comment, $size = '100', $default = 'http://i855.photobucket.com/albums/ab118/babygirlsaranghae/gravatar_zpsad701a04.jpg' ); ?>
			<br />
			<a href="<?php comment_author_url(); ?>" class="author" target="_blank"><?php comment_author(); ?></a>
   				<br />
 				<div class="commentmeta"> <?php comment_date('F dS, Y') ?> <a href="#comment-<?php comment_ID() ?>">@</a> <?php comment_time() ?>
 				<?php edit_comment_link('Edit','<br />',''); ?></div>
 			</td>
...
<p align="center"><input name="submit" type="submit" id="submit" width="60%" tabindex="5" value="Submit"/>
